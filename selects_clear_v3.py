...
def avg_mark_teacher(chart_type, region,
                     teacher_id, class_id=None, school_id=None,
                     subject_id=None, topic=None,
                     mark_type=None,
                     date1=None, date2=None, title=None):
    myreg = mydb['region']
...
def alerts_compare_line(sub_big, sub_small):
    ...
    for item in sub_small:
        ...
        if mark is not None:
            print(item, mark, sub_small[item])
            if 0 < (mark - sub_small[item]) >= 0.5:
                alert_bool.update({item: "Low marks"})
            elif (mark - sub_small[item]) <= -0.5:
                alert_bool.update({item: "Hight marks"})
            else:
                pass
    return alert_bool
...
if __name__ == "__main__":
    ...
    for i in range(20):
        ...
        print(i)
        print(alerts_compare_line(alerts_get_avg_line(mas), alerts_get_avg_line(mas1)))
